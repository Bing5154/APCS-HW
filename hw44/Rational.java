// Team PERSPIRATION -- Bing Li, Victor Lin
// APCS1 p2
...
public class Rational implements Comparable
{
  ...
  public boolean equals( Object other )
  {
    ...
    Rational hey = (Rational)other;
    hey.reduce();

    return hey instanceof Rational
            && this._numerator == hey._numerator
            && this._denominator == hey._denominator;
  }//end equals()
   ...
   *********************/
	...
	/* YOUR IMPLEMENTATION HERE */
	   ...
	   throw new ClassCastException("THIS IS NOT RATIONAL");
	}
  ...
  public static void main( String[] args )
  {
      ...
      System.out.println("current Rational v: " + v);
      System.out.println("current Rational w: " + w);
      System.out.println("current Rational x: " + x);
      System.out.println("current Rational t: " + t);
      System.out.println("current Rational s: " + s);
